# AirDesk - Account & Credential Transfer Checklist
...
- **Key Details:**
  ...
  - Domain: www.airdesk.com (if applicable)
...
- **Current Domain:** (if applicable - www.airdesk.com)

### 8. GitHub Repository
- **URL:** https://github.com
- **Action Required:**
  - Transfer repository ownership OR add buyer as collaborator
- **Repository:** faizanprofitpilot/AirDesk (or current repo name)
...
```env
# Application
NEXT_PUBLIC_APP_URL=https://www.airdesk.com
