...
export async function POST(req: NextRequest) {
  try {
    ...
    // Log knowledge base being applied
    console.log('[Update Assistant] Knowledge base:', firm.ai_knowledge_base || 'none');
    console.log('[Update Assistant] System prompt length:', agentConfig.model.messages[0]?.content?.length || 0);
