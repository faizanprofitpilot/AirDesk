    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <p className="text-sm mb-4" style={{ color: '#475569' }}>
          Add context about your HVAC business to help the AI receptionist answer questions more effectively. 
          Include information like service areas, specialties, warranty policies, or anything else that would help the AI assist customers.
        </p>

        <div className="mb-4">
          <label htmlFor="knowledgeBase" className="block text-sm font-semibold mb-2 uppercase tracking-wide" style={{ color: '#475569' }}>
            Additional Context
          </label>
          <textarea
            id="knowledgeBase"
            ...
            placeholder="Example: We specialize in residential and commercial HVAC services including heating, cooling, air quality, and ductwork. We serve the greater metro area and offer 24/7 emergency service. We provide free estimates and offer financing options..."
            rows={10}
          ...
          <p className="text-xs mt-2" style={{ color: '#6B7280' }}>
            This information will be provided to the AI to help it better understand your HVAC business and answer customer questions.
          </p>
        </div>
