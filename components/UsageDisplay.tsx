...
export default function UsageDisplay({
  ...
  return (
    <div className="space-y-4">
      {/* Trial Ended Banner */}
      {isTrialEnded && (
        <div className="bg-gradient-to-r from-[#F97316] to-[#D4B85A] rounded-xl p-6 shadow-lg border-2 border-[#F97316]">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h3 className="text-lg font-bold mb-2" style={{ color: '#1E40AF' }}>
                Your Free Trial Has Ended
              </h3>
              <p className="text-sm mb-4" style={{ color: '#1E40AF', opacity: 0.9 }}>
                Continue using AirDesk by upgrading to a paid plan. Choose the plan that best fits your HVAC business needs.
              </p>
              <Link
                href="/billing"
      ...
      <div className="bg-white rounded-xl shadow-sm p-6" style={{ boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)' }}>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <div className="text-2xl font-bold" style={{ color: isOverLimit ? '#EF4444' : '#1E40AF' }}>
              {usage.used.toFixed(1)}
            </div>
            <div className="text-sm" style={{ color: '#475569', opacity: 0.7 }}>
        ...
        <div className="flex items-center justify-between text-sm">
          <div style={{ color: '#475569', opacity: 0.7 }}>
            {usage.remaining > 0 ? (
